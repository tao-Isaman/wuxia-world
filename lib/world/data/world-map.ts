...
const SECTS: LocationScene[] = [
  ...
  leaf(
    "sect_tang",
    "สำนักสุลถัง",
    "唐门 · เสฉวน · ตระกูลถังผู้เชี่ยวชาญอาวุธลับและพิษ · ไม่ค่อยเปิดเผยตัวต่อยุทธจักร",
  ),
];
