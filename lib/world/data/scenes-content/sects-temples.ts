...
export const SCENES_SECTS_TEMPLES: readonly Scene[] = [
  ...
  // Disciple intro — offer beat (NPC popup auto-routes here after Accept).
  // Pure narration: brief the trial (gold + iron) and bounce back to the
  // courtyard so the player can leave and prepare. Mirror the
  // shaolin/wudang intro pattern — no startQuest effect.
  {
    kind: "dialog",
  ...
  // Disciple intro — complete beat. The choice gates on goldAtLeast 200
  // and effects deduct gold + iron at acceptance. Reward chain (joinSect
  // + sectPoints) runs after via finishQuest.
  {
    kind: "dialog",
  ...
  // Vice master ambient — wisdom on perseverance.
  {
    kind: "dialog",
  ...
  // Sword elder ambient — invitation to spar.
  {
    kind: "dialog",
  ...
  // ══════════════════════════════════════════════════════════════════════
  // ฉวนเจิน — อาจารย์ใหญ่ฉงหยาง (ascetic Daoist, no entry fee)
  // ══════════════════════════════════════════════════════════════════════
  ...
  // Disciple intro — offer beat (NPC popup auto-routes here after Accept).
  // Pure narration: brief the herb-gathering trial and bounce back to
  // the courtyard. Mirror the wudang/shaolin pattern — no startQuest.
  {
    kind: "dialog",
  ...
  // finishQuest → reward chain joinSect:quanzhen seeds membership at
  // rank 9 and auto-grants T0 sword + T0 art.
  {
    kind: "dialog",
  ...
  // ══════════════════════════════════════════════════════════════════════
  // สำนักสุลถัง — เจ้าสำนักถังเหมิน (Sichuan Tang clan)
  // ══════════════════════════════════════════════════════════════════════
  ...
  // Disciple intro — offer beat. Chief gives explicit hints about
  // where to gather each material (per spec: dialog should be clear).
  {
    kind: "dialog",
  ...
  // Disciple intro — complete beat. Player has all 4 items; choice
  // fires takeItem on each + finishQuest → joinSect:tang grants
  // tang_basic_knife + t0_tang_sharp.
  {
    kind: "dialog",
