...
export const NPCS_SECTS_TEMPLES: readonly NpcDef[] = [
  ...
  // ─── สำนักสุลถัง ─────────────────────────────────────────────────────
  // Tang sect (唐门 Sichuan family). Big sect, T4 chief tier — leader
  // Tangmen is one of the strongest in the world. Combat identity:
  // hidden weapons + poisons (yin / external).
  {
