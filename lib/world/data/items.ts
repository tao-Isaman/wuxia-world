...
export const ITEMS: readonly ItemDef[] = [
  ...
  { id: "man_nd5", name: "ตำราอรหันต์พันมือ", category: "manual", price: 800,
    description: "ตำราเส้าหลินขั้นกลาง · ฝ่ามือทุกทิศตาเปล่ายากตาม",
    use: { t: "manualLearnSkill", skillId: "nd5", reqStat: "INT", reqValue: 10 } },
