...
export const ARTS: readonly Art[] = [
  ...
  // ─── ซงซาน ───
  { id: "t0_ssh_qi", n: "กำลังภายในซงซาน", sc: "ซงซาน", tp: "สมดุล", types: ["balance"], ti: 0,
    stats: { STR: 4, VIT: 3, POW: 3 }, hL: 18, mL: 12,
    act: { n: "ลมปราณเหล็ก", c: 12, cd: 3, t: "heal", h: 8, d: "ฟื้น 8% HP CD3" },
    pas: { tr: "use_act", ch: 100, d: "ใช้ IA → ATK+5% (≤3 ซ้อน)", e: { t: "stack_atk", v: 5, mx: 3 } } },
  { id: "t1_ssh_iron", n: "วิชาเหล็กหนัก", sc: "ซงซาน", tp: "สมดุล", types: ["balance"], ti: 1,
    stats: { STR: 7, DEX: 6, POW: 5 }, hL: 22, mL: 18,
    act: { n: "ลมปราณเหล็กหนัก", c: 18, cd: 3, t: "buff_reduce", v: 18, u: 5, d: "ลด dmg 18% (5ตา) CD3" },
    pas: { tr: "use_act", ch: 100, d: "ใช้ IA → ATK+6% (≤3 ซ้อน) — เหล็กหนักสะสมแรง", e: { t: "stack_atk", v: 6, mx: 3 } } },
  { id: "t2_ssh_root", n: "พลังรากภูผา", sc: "ซงซาน", tp: "สมดุล·แข็ง", types: ["balance", "hard"], ti: 2,
    stats: { STR: 10, VIT: 8, POW: 5, DEX: 3 }, hL: 25, mL: 25,
    act: { n: "รากภูผาตรึง", c: 22, cd: 3, t: "atk_phy_pen", m: 1.3, pen: 22, d: "Phy×1.3 ทะลุ DEF 22% CD3" },
    pas: { tr: "on_crit", ch: 100, d: "Crit → ATK+7% (≤4 ซ้อน) — รากภูผาสะสมแรง", e: { t: "stack_atk", v: 7, mx: 4 } } },
  { id: "t3_ssh_pillar", n: "พลังเสาภูผา", sc: "ซงซาน", tp: "สมดุล·แข็ง", types: ["balance", "hard"], ti: 3,
    stats: { STR: 14, POW: 10, VIT: 8, DEX: 4 }, hL: 32, mL: 28,
    act: { n: "เสาภูผาทับฟ้า", c: 28, cd: 3, t: "atk_phy_pen", m: 1.45, pen: 32, d: "Phy×1.45 ทะลุ DEF 32% CD3 — เสาภูผาทับลงบนศัตรู" },
    pas: { tr: "on_crit", ch: 100, d: "Crit → ATK+10% (≤4 ซ้อน) — เสาภูผาสะสมแรงไม่จบ", e: { t: "stack_atk", v: 10, mx: 4 } } },

  // ─── ไท่ซาน ───
  { id: "t0_tsh_qi", n: "กำลังภายในไท่ซาน", sc: "ไท่ซาน", tp: "หยาง", types: ["yang"], ti: 0,
    stats: { STR: 4, DEX: 3, POW: 3 }, hL: 16, mL: 14,
    act: { n: "ลมปราณบูรพา", c: 12, cd: 3, t: "heal", h: 8, d: "ฟื้น 8% HP CD3" },
    pas: { tr: "use_act", ch: 100, d: "ใช้ IA → ATK+5% (≤3 ซ้อน)", e: { t: "stack_atk", v: 5, mx: 3 } } },
  { id: "t1_tsh_dawn", n: "วิชาตวัดอรุณ", sc: "ไท่ซาน", tp: "หยาง", types: ["yang"], ti: 1,
    stats: { STR: 6, DEX: 6, AGI: 4, POW: 2 }, hL: 22, mL: 18,
    act: { n: "อรุณวิภา", c: 18, cd: 3, t: "buff_eva_debuff_eva", selfV: 12, eneV: -10, u: 5, d: "Eva+12 / ศัตรู Eva-10 (5ตา) CD3" },
    pas: { tr: "on_crit", ch: 100, d: "Crit → ศัตรู Eva-10 (5ตา)", e: { t: "debuff_eva", n: "ตวัดอรุณ", v: -10, u: 5 } } },
  { id: "t2_tsh_peak", n: "พลังยอดเขาบูรพา", sc: "ไท่ซาน", tp: "หยาง·ภายนอก", types: ["yang", "external"], ti: 2,
    stats: { STR: 9, DEX: 8, AGI: 5, POW: 4 }, hL: 26, mL: 24,
    act: { n: "ยอดเขาทะลวงเมฆ", c: 24, cd: 3, t: "atk_phy_pen", m: 1.3, pen: 22, d: "Phy×1.3 ทะลุ DEF 22% CD3" },
    pas: { tr: "use_act", ch: 100, d: "ใช้ IA → ATK+7% (≤4 ซ้อน)", e: { t: "stack_atk", v: 7, mx: 4 } } },
  { id: "t3_tsh_sun", n: "หนึ่งกระบี่บูชาตะวัน", sc: "ไท่ซาน", tp: "หยาง·ภายนอก", types: ["yang", "external"], ti: 3,
    stats: { STR: 14, DEX: 12, AGI: 6, POW: 4 }, hL: 32, mL: 28,
    act: { n: "บูชาตะวัน", c: 28, cd: 3, t: "atk_phy_pen", m: 1.45, pen: 28, d: "Phy×1.45 ทะลุ DEF 28% CD3" },
    pas: { tr: "use_act", ch: 100, d: "ใช้ IA → ATK+10% (≤4 ซ้อน) — บูชาตะวันสะสมเเสง", e: { t: "stack_atk", v: 10, mx: 4 } } },

  // ─── เฮิงซาน ───
  { id: "t0_hgs_breath", n: "ลมหายใจห้ายอด", sc: "เฮิงซาน", tp: "หยิน", types: ["yin"], ti: 0,
    stats: { AGI: 5, DEX: 3, POW: 2 }, hL: 12, mL: 18,
    act: { n: "ลมหายใจสงบ", c: 12, cd: 3, t: "heal", h: 8, d: "ฟื้น 8% HP CD3" },
    pas: { tr: "hit_recv", ch: 25, d: "ถูกโจมตี 25% → Eva+8 (5ตา)", e: { t: "buff_eva", n: "ลมหายใจ", v: 8, u: 5 } } },
  { id: "t1_hgs_step", n: "ตัวเบาเฮิงซาน", sc: "เฮิงซาน", tp: "หยิน", types: ["yin"], ti: 1,
    stats: { AGI: 9, DEX: 5, POW: 4 }, hL: 18, mL: 22,
    act: { n: "ก้าวเหินเมฆ", c: 18, cd: 3, t: "buff_eva_debuff_eva", selfV: 15, eneV: -10, u: 5, d: "Eva+15 / ศัตรู Eva-10 (5ตา) CD3" },
    pas: { tr: "use_act", ch: 100, d: "ใช้ IA → Eva+10 (5ตา)", e: { t: "buff_eva", n: "ตัวเบา", v: 10, u: 5 } } },
  { id: "t2_hgs_cloud", n: "ระบำเมฆาห้ายอด", sc: "เฮิงซาน", tp: "หยิน·อ่อน", types: ["yin", "soft"], ti: 2,
    stats: { AGI: 12, DEX: 8, POW: 4, LUK: 2 }, hL: 22, mL: 28,
    act: { n: "ระบำเมฆเหิร", c: 22, cd: 3, t: "buff_reduce", v: 22, u: 5, d: "ลด dmg 22% (5ตา) CD3" },
    pas: { tr: "on_crit", ch: 100, d: "Crit → Eva+12 (5ตา)", e: { t: "buff_eva", n: "เมฆาห้ายอด", v: 12, u: 5 } } },
  { id: "t3_hgs_swift", n: "ลมรวดเร็ว", sc: "เฮิงซาน", tp: "หยิน·อ่อน", types: ["yin", "soft"], ti: 3,
    stats: { AGI: 16, DEX: 10, POW: 6, LUK: 4 }, hL: 28, mL: 32,
    act: { n: "พายุห้ายอด", c: 28, cd: 3, t: "buff_eva_debuff_eva", selfV: 25, eneV: -18, u: 5, d: "Eva+25 / ศัตรู Eva-18 (5ตา) CD3" },
    pas: { tr: "on_crit", ch: 100, d: "Crit → Eva+25 (5ตา)", e: { t: "buff_eva", n: "ลมรวดเร็ว", v: 25, u: 5 } } },

  // ─── เหิงซาน ───
  { id: "t0_hgn_zen", n: "ลมปราณนิ่งสงบ", sc: "เหิงซาน", tp: "อ่อน", types: ["soft", "external"], ti: 0,
    stats: { POW: 4, VIT: 3, DEX: 3 }, hL: 18, mL: 15,
    act: { n: "ลมปราณธรรม", c: 12, cd: 3, t: "heal", h: 8, d: "ฟื้น 8% HP CD3" },
    pas: { tr: "hit_recv", ch: 25, d: "ถูกโจมตี 25% → DEF+10 (5ตา)", e: { t: "buff_def", n: "ลมปราณเหิงซาน", v: 10, u: 5 } } },
  { id: "t1_hgn_shield", n: "โล่ธรรมจักรวาล", sc: "เหิงซาน", tp: "อ่อน", types: ["soft", "external"], ti: 1,
    stats: { POW: 5, VIT: 8, DEX: 5 }, hL: 22, mL: 18,
    act: { n: "โล่ธรรม", c: 18, cd: 3, t: "buff_reduce", v: 22, u: 5, d: "ลด dmg 22% (5ตา) CD3" },
    pas: { tr: "hit_recv", ch: 30, d: "ถูกโจมตี 30% → DEF+12 (5ตา)", e: { t: "buff_def", n: "โล่ธรรม", v: 12, u: 5 } } },
  { id: "t2_hgn_bell", n: "ระฆังพระธรรม", sc: "เหิงซาน", tp: "อ่อน·ภายนอก", types: ["soft", "external"], ti: 2,
    stats: { POW: 7, VIT: 10, DEX: 5, AGI: 4 }, hL: 28, mL: 24,
    act: { n: "เสียงระฆังกังวาน", c: 22, cd: 3, t: "buff_reflect", v: 30, u: 5, d: "สะท้อน 30% (5ตา) CD3" },
    pas: { tr: "hit_recv", ch: 35, d: "ถูกโจมตี 35% → DEF+16 (5ตา) — เสียงระฆังต้านสะเทือน", e: { t: "buff_def", n: "ระฆังธรรม", v: 16, u: 5 } } },
  { id: "t3_hgn_mirror", n: "พลังกระจกธรรม", sc: "เหิงซาน", tp: "อ่อน·ภายนอก", types: ["soft", "external"], ti: 3,
    stats: { POW: 10, VIT: 14, DEX: 7, AGI: 5 }, hL: 35, mL: 30,
    act: { n: "กระจกสะท้อนฟ้า", c: 28, cd: 3, t: "buff_reflect", v: 50, u: 5, d: "สะท้อน 50% (5ตา) CD3" },
    pas: { tr: "hit_recv", ch: 40, d: "ถูกโจมตี 40% → DEF+22 (5ตา) — กระจกธรรมแกร่งดั่งหิน", e: { t: "buff_def", n: "กระจกธรรม", v: 22, u: 5 } } },
  ...
  // ─── พรรคตะวันจันทรา ───
  { id: "t0_sm_dual", n: "พลังสองขั้ว", sc: "พรรคตะวันจันทรา", tp: "สมดุล·ภายใน", types: ["balance", "internal"], ti: 0,
    stats: { POW: 4, INT: 4, VIT: 2 }, hL: 16, mL: 14,
    act: { n: "สองขั้ว", c: 12, cd: 3, t: "heal", h: 9, d: "ฟื้น 9% HP CD3" },
    pas: { tr: "hit_recv", ch: 20, d: "ถูกโจมตี 20% → DEF+8 (5ตา)", e: { t: "buff_def", n: "สองขั้ว", v: 8, u: 5 } } },
  { id: "t1_sm_sunfire", n: "พลังเพลิงตะวัน", sc: "พรรคตะวันจันทรา", tp: "หยาง·ภายใน", types: ["yang", "internal"], ti: 1,
    stats: { POW: 7, INT: 5, STR: 3 }, hL: 18, mL: 22,
    act: { n: "เพลิงตะวัน", c: 18, cd: 3, t: "atk_int_pen", m: 1.3, pen: 20, d: "Int×1.3 ทะลุ IDef 20% CD3" },
    pas: { tr: "use_int", ch: 30, d: "Int skill 30% → ATK+5% (≤3 ซ้อน)", e: { t: "stack_atk", v: 5, mx: 3 } } },
  { id: "t1_sm_moonweave", n: "พลังร้อยจันทรา", sc: "พรรคตะวันจันทรา", tp: "หยิน·ภายใน", types: ["yin", "internal"], ti: 1,
    stats: { POW: 6, INT: 6, AGI: 3 }, hL: 22, mL: 18,
    act: { n: "ร้อยจันทรา", c: 18, cd: 3, t: "buff_reflect", v: 25, u: 5, d: "สะท้อน 25% (5ตา) CD3" },
    pas: { tr: "use_int", ch: 30, d: "Int skill 30% → Eva+8 (5ตา)", e: { t: "buff_eva", n: "จันทรา", v: 8, u: 5 } } },
  { id: "t2_sm_sunbody", n: "พลังกายสุริยัน", sc: "พรรคตะวันจันทรา", tp: "หยาง·ภายใน", types: ["yang", "internal"], ti: 2,
    stats: { STR: 8, POW: 7, VIT: 5 }, hL: 28, mL: 22,
    act: { n: "กายสุริยัน", c: 22, cd: 3, t: "atk_int_pen", m: 1.35, pen: 25, d: "Int×1.35 ทะลุ IDef 25% CD3" },
    pas: { tr: "on_crit", ch: 100, d: "Crit → ATK+8% (≤3 ซ้อน)", e: { t: "stack_atk", v: 8, mx: 3 } } },
  { id: "t2_sm_moonbody", n: "พลังกายจันทรา", sc: "พรรคตะวันจันทรา", tp: "หยิน·ภายใน", types: ["yin", "internal"], ti: 2,
    stats: { POW: 8, INT: 8, AGI: 4 }, hL: 25, mL: 25,
    act: { n: "กายจันทรา", c: 22, cd: 3, t: "heal_cleanse", h: 18, d: "ฟื้น 18%HP + ลบ debuff CD3" },
    pas: { tr: "use_int", ch: 50, d: "Int skill 50% → Eva+10 (5ตา)", e: { t: "buff_eva", n: "จันทรา", v: 10, u: 5 } } },
  { id: "t3_sm_dualfusion", n: "พลังสองขั้วผสาน", sc: "พรรคตะวันจันทรา", tp: "สมดุล·ภายใน", types: ["balance", "internal"], ti: 3,
    stats: { POW: 12, INT: 12, VIT: 8, AGI: 8 }, hL: 35, mL: 25,
    act: { n: "ผสานหยินหยาง", c: 28, cd: 3, t: "heal_cleanse", h: 25, d: "ฟื้น 25%HP + ลบ debuff CD3" },
    pas: { tr: "use_int", ch: 100, d: "Int skill → IAtk+12%", e: { t: "mult_iatk" } } },
  { id: "t3_sm_sunmoon", n: "พลังสุริยันจันทรา", sc: "พรรคตะวันจันทรา", tp: "สมดุล·ภายใน", types: ["balance", "internal"], ti: 3,
    stats: { STR: 10, POW: 14, INT: 12, VIT: 4 }, hL: 30, mL: 30,
    act: { n: "สุริยันจันทรา", c: 30, cd: 3, t: "atk_int_pen", m: 1.45, pen: 30, d: "Int×1.45 ทะลุ IDef 30% CD3 — รวมพลังตะวันและจันทรา" },
    pas: { tr: "use_act", ch: 100, d: "ใช้ IA → ATK+10% (≤3 ซ้อน)", e: { t: "stack_atk", v: 10, mx: 3 } } },
  { id: "t3_sm_sunscript", n: "คัมภีร์ทานตะวัน (ฉบับย่อ)", sc: "พรรคตะวันจันทรา", tp: "หยิน·ภายนอก", types: ["yin", "external"], ti: 3,
    stats: { STR: 14, VIT: 12, DEF: 10, AGI: 4 }, hL: 40, mL: 20,
    act: { n: "ทานตะวัน", c: 28, cd: 3, t: "buff_reduce", v: 30, u: 5, d: "ลด dmg 30% (5ตา) CD3" },
    pas: { tr: "hit_recv", ch: 30, d: "ถูกโจมตี 30% → ฟื้น 8% HP", e: { t: "heal_pct", v: 8 } } },
  { id: "qiankun", n: "เฉียนคุนต้าหนัวอี", sc: "พรรคตะวันจันทรา", tp: "สมดุล·ภายใน", types: ["internal"], ti: 4,
  ...
  { id: "yxhd", n: "ดาวเคลื่อนดาราคล้อย", sc: "พรรคตะวันจันทรา", tp: "สมดุล·อ่อน", types: ["soft"], ti: 4,
  ...
  // ─── พรรคสราญรมย์ ───
  { id: "t0_xy_plum", n: "ลมปราณดอกเหมย", sc: "พรรคสราญรมย์", tp: "หยิน·ภายใน", types: ["yin", "internal"], ti: 0,
    stats: { POW: 4, INT: 4, AGI: 2 }, hL: 14, mL: 16,
    act: { n: "ดอกเหมย", c: 12, cd: 3, t: "heal", h: 9, d: "ฟื้น 9% HP CD3" },
    pas: { tr: "use_int", ch: 25, d: "Int 25% → ATK+5% (≤3 ซ้อน)", e: { t: "stack_atk", v: 5, mx: 3 } } },
  { id: "t1_xy_formless_lesser", n: "พลังไร้ลักษณ์น้อย", sc: "พรรคสราญรมย์", tp: "หยิน·ภายใน", types: ["yin", "internal"], ti: 1,
    stats: { POW: 6, INT: 6, AGI: 3 }, hL: 18, mL: 22,
    act: { n: "ไร้ลักษณ์", c: 18, cd: 3, t: "buff_reflect", v: 25, u: 5, d: "สะท้อน 25% (5ตา) CD3" },
    pas: { tr: "use_int", ch: 30, d: "Int 30% → Eva+8 (5ตา)", e: { t: "buff_eva", n: "ไร้ลักษณ์", v: 8, u: 5 } } },
  { id: "t2_xy_formless_greater", n: "พลังไร้ลักษณ์ใหญ่", sc: "พรรคสราญรมย์", tp: "หยิน·ภายใน", types: ["yin", "internal"], ti: 2,
    stats: { POW: 10, INT: 8, AGI: 6, DEX: 6 }, hL: 25, mL: 25,
    act: { n: "ไร้ลักษณ์ใหญ่", c: 22, cd: 3, t: "buff_reflect", v: 35, u: 5, d: "สะท้อน 35% (5ตา) CD3" },
    pas: { tr: "use_int", ch: 50, d: "Int 50% → Eva+12 (5ตา)", e: { t: "buff_eva", n: "ไร้ลักษณ์ใหญ่", v: 12, u: 5 } } },
  { id: "t3_xy_root_poison_qi", n: "ลมปราณรากพิษ", sc: "พรรคสราญรมย์", tp: "อ่อน·ภายใน", types: ["soft", "internal"], ti: 3,
    stats: { POW: 12, INT: 14, DEX: 8, LUK: 6 }, hL: 30, mL: 30,
    act: { n: "รากพิษ", c: 28, cd: 3, t: "atk_int_pen", m: 1.4, pen: 25, d: "Int×1.4 ทะลุ IDef 25% CD3" },
    pas: { tr: "use_int", ch: 100, d: "Int → ศัตรู Acc-12 (5ตา)", e: { t: "debuff_acc", n: "รากพิษ", v: -12, u: 5 } } },
  { id: "t3_xy_seepower", n: "วิชาดูพลัง", sc: "พรรคสราญรมย์", tp: "หยิน·ภายใน", types: ["yin", "internal"], ti: 3,
    stats: { POW: 16, INT: 14, AGI: 6, LUK: 4 }, hL: 30, mL: 30,
    act: { n: "ดูพลัง", c: 28, cd: 3, t: "drain", m: 1.3, h: 30, d: "Int×1.3 + ดูด 30%HP CD3" },
    pas: { tr: "use_int", ch: 100, d: "Int → IAtk+12%", e: { t: "mult_iatk" } } },
  ...
  // ─── สำนักสุลถัง ───
  { id: "t0_tang_sharp", n: "สมาธิเฉียบคม", sc: "สำนักสุลถัง", tp: "สมดุล·ภายนอก", types: ["balance", "external"], ti: 0,
    stats: { DEX: 4, AGI: 4, LUK: 2 }, hL: 14, mL: 16,
    act: { n: "เฉียบคม", c: 12, cd: 3, t: "heal", h: 8, d: "ฟื้น 8% HP CD3" },
    pas: { tr: "on_crit", ch: 100, d: "Crit → ATK+5% (≤3 ซ้อน)", e: { t: "stack_atk", v: 5, mx: 3 } } },
  { id: "t1_tang_venombody", n: "กายาร้อยพิษ", sc: "สำนักสุลถัง", tp: "หยิน·ภายนอก", types: ["yin", "external"], ti: 1,
    stats: { DEX: 6, VIT: 5, LUK: 4 }, hL: 22, mL: 18,
    act: { n: "ร้อยพิษ", c: 18, cd: 3, t: "buff_reduce", v: 18, u: 5, d: "ลด dmg 18% (5ตา) CD3" },
    pas: { tr: "hit_recv", ch: 25, d: "ถูกโจมตี 25% → DEF+8 (5ตา)", e: { t: "buff_def", n: "ร้อยพิษ", v: 8, u: 5 } } },
  { id: "t2_tang_wavewind", n: "ท่าร่างคลื่นลม", sc: "สำนักสุลถัง", tp: "สมดุล·ภายนอก", types: ["balance", "external"], ti: 2,
    stats: { AGI: 9, DEX: 7, STR: 4 }, hL: 25, mL: 25,
    act: { n: "คลื่นลม", c: 22, cd: 3, t: "buff_reflect", v: 28, u: 5, d: "สะท้อน 28% (5ตา) CD3" },
    pas: { tr: "use_act", ch: 100, d: "ใช้ IA → Eva+10 (5ตา)", e: { t: "buff_eva", n: "คลื่นลม", v: 10, u: 5 } } },
  { id: "t3_tang_viperpower", n: "พลังอสรพิษ", sc: "สำนักสุลถัง", tp: "หยิน·ภายนอก", types: ["yin", "external"], ti: 3,
    stats: { DEX: 12, AGI: 8, LUK: 6, STR: 4 }, hL: 30, mL: 30,
    act: { n: "พิษอสรพิษ", c: 28, cd: 3, t: "atk_phy_pen", m: 1.4, pen: 30, d: "Phy×1.4 ทะลุ DEF 30% CD3" },
    pas: { tr: "on_crit", ch: 100, d: "Crit → ATK+8% (≤4 ซ้อน) — พิษสะสม", e: { t: "stack_atk", v: 8, mx: 4 } } },
  { id: "t3_tang_chase", n: "ท่าเท้าไล่ล่า", sc: "สำนักสุลถัง", tp: "สมดุล·ภายนอก", types: ["balance", "external"], ti: 3,
    stats: { AGI: 14, DEX: 10, STR: 4, LUK: 2 }, hL: 28, mL: 32,
    act: { n: "ไล่ล่า", c: 25, cd: 3, t: "buff_reduce", v: 25, u: 5, d: "ลด dmg 25% (5ตา) CD3" },
    pas: { tr: "use_act", ch: 100, d: "ใช้ IA → Eva+12 (5ตา)", e: { t: "buff_eva", n: "ไล่ล่า", v: 12, u: 5 } } },
  { id: "t4_tang_tenkpoisons", n: "พลังถังหมื่นพิษ", sc: "สำนักสุลถัง", tp: "หยิน·ภายนอก", types: ["yin", "external"], ti: 4,
    stats: { DEX: 18, AGI: 12, LUK: 8, STR: 4 }, hL: 35, mL: 35,
    act: { n: "หมื่นพิษ", c: 32, cd: 4, t: "atk_phy_pen", m: 1.55, pen: 40, d: "Phy×1.55 ทะลุ DEF 40% CD4 — รวมพิษหมื่นชนิด" },
    pas: { tr: "use_act", ch: 100, d: "ใช้ IA → ATK+10% (≤4 ซ้อน)", e: { t: "stack_atk", v: 10, mx: 4 } } },
  { id: "t4_tang_skycleaver", n: "พลังกรัดฟ้า", sc: "สำนักสุลถัง", tp: "สมดุล·ภายนอก", types: ["balance", "external"], ti: 4,
    stats: { STR: 14, DEX: 14, AGI: 12, LUK: 4 }, hL: 40, mL: 30,
    act: { n: "กรัดฟ้า", c: 35, cd: 4, t: "atk_phy_pen", m: 1.6, pen: 40, d: "Phy×1.6 ทะลุ DEF 40% CD4 — มีดผ่าฟ้าของถังเหมิน" },
    pas: { tr: "on_crit", ch: 100, d: "Crit → ATK+12% (≤4 ซ้อน) — กรัดฟ้า", e: { t: "stack_atk", v: 12, mx: 4 } } },
