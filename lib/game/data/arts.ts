...
export const ARTS: readonly Art[] = [
  ...
  { id: "tendon", n: "พลังเปลี่ยนเส้นเอ็น", sc: "เส้าหลิน", tp: "หยาง·แข็ง", types: ["yang", "hard"],
  ...
  { id: "diamond", n: "จินกังชี่", sc: "เส้าหลิน", tp: "หยาง·แข็ง", types: ["yang", "hard"],
  ...
  { id: "wanderer", n: "เจียงหูชี่", sc: "ยาจก", tp: "แข็ง·ภายนอก", types: ["hard", "external"],
  ...
  { id: "military", n: "จวินเจิ้นชี่", sc: "องครักษ์", tp: "หยาง·ภายนอก", types: ["yang", "external"],
  ...
  { id: "taiji", n: "ไทจี้เจิ้นชี่", sc: "อู่ตัง", tp: "สมดุล·อ่อน", types: ["soft"],
  ...
  { id: "lotus", n: "เหลียนฮวาชี่", sc: "บัวขาว", tp: "สมดุล·อ่อน", types: ["soft"],
  ...
  { id: "scholar", n: "เหวินชี่", sc: "หมู่ตึกบรรณฑิต", tp: "สมดุล·ภายใน", types: ["internal"],
  ...
  { id: "poison", n: "อินตู๋ชี่", sc: "ถังเหมิน", tp: "หยิน·อ่อน", types: ["yin", "soft"],
  ...
  { id: "heaven", n: "เฉียนคุนต้าฝ่า", sc: "ลัทธิฟ้าดิน", tp: "สมดุล·ภายใน", types: ["internal"],
  ...
  { id: "blood", n: "โลหิตอสุรา", sc: "สำนักดาบโลหิต", tp: "หยาง·แข็ง", types: ["yang", "hard"],
  ...
  { id: "snow", n: "กำแพงหิมะ", sc: "สำนักน้ำแข็ง", tp: "หยิน·แข็ง", types: ["yin", "hard"],
  ...
  { id: "fire", n: "เพลิงสวรรค์", sc: "สำนักเพลิง", tp: "หยาง·ภายใน", types: ["yang", "internal"],
  ...
  { id: "sand", n: "พายุทราย", sc: "สำนักพายุ", tp: "สมดุล·ภายนอก", types: ["external"],
  ...
  { id: "shadow", n: "เงาสังหาร", sc: "สำนักเงา", tp: "หยิน·ภายนอก", types: ["yin", "external"],
  ...
  { id: "jiuyin", n: "เก้าหยินจิงชี่", sc: "คัมภีร์เก้าหยิน", tp: "หยิน·ภายใน", types: ["yin", "internal"],
  ...
  { id: "jiuyang", n: "เก้าหยางเซินกง", sc: "คัมภีร์เก้าหยาง", tp: "หยาง·แข็ง", types: ["yang", "hard"],
  ...
  { id: "qiankun", n: "เฉียนคุนต้าหนัวอี", sc: "ลัทธิหมิง", tp: "สมดุล·ภายใน", types: ["internal"],
  ...
  { id: "zixia", n: "จื่อเสียเซินกง", sc: "อู่ตัง", tp: "สมดุล·อ่อน", types: ["soft"],
  ...
  { id: "emei", n: "ง้อไบ๊เซินกง", sc: "ง้อไบ๊", tp: "สมดุล·ภายใน", types: ["internal"],
  ...
  { id: "shenzhao", n: "เซินจ้าวจิง", sc: "พรรคบู๊ลิ้ม", tp: "สมดุล·ภายใน", types: ["internal"],
  ...
  { id: "taiyin", n: "ไต้อินเจิ้นชี่", sc: "สำนักมาร", tp: "หยิน·อ่อน", types: ["yin", "soft"],
  ...
  { id: "huoxue", n: "ฮั่วเสวียสินฝ่า", sc: "หมอยุทธ", tp: "สมดุล·ภายใน", types: ["internal"],
    stats: { VIT: 25, POW: 15, DEF: 10 }, hL: 50, mL: 20,
    act: { n: "โลหิตรักษา", c: 25, cd: 3, t: "heal", h: 30, d: "ฟื้น 30% HP CD3" },
    pas: { tr: "hit_recv", ch: 20, d: "ถูกโจมตี 20% → ฟื้น 8% HP", e: { t: "heal_pct", v: 8 } } },

  { id: "huashan", n: "หัวซานเซินกง", sc: "หัวซาน", tp: "สมดุล·แข็ง", types: ["hard"],
  ...
  { id: "dongxuan", n: "ตงซวนเซินกง", sc: "สำนักมืด", tp: "หยิน·ภายใน", types: ["yin", "internal"],
