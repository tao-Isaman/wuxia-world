...
export const SKILLS: readonly Skill[] = [
  ...
  // Sect-line skills (อู่ตัง disciple system) — balance / soft / internal core, sword + fist split.
  ...
  // ─── หัวซาน ───────────────────────────────────────────────────────
  { id: "dgjj", n: "เก้ากระบี่เดียวดาย", sc: "หัวซาน", ti: 4, w: "sword", mg: 100, st: { STR: 6, AGI: 8, DEX: 6 }, at: "phy", bp: 90, p: 30, f: 0, dm: 1.2, hits: 9, se: { t: "buff_spd", v: 60, u: 5 }, ee: { t: "debuff_eva", v: -20, u: 5 }, d: "Phy×130% · ตี 9 กระบี่ + SPD+60(2ตา) + Eva-20(2ตา) — 独孤九剑", types: ["yang"] },
