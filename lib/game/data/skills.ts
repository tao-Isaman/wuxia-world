...
export const SKILLS: readonly Skill[] = [
  ...
  { id: "nd5", n: "หมัดอรหันต์", sc: "เส้าหลิน", ti: 1, w: "fist", mg: 40, st: { STR: 6, VIT: 7 }, at: "phy", bp: 50, p: 0, f: 10, dm: 1, se: null, ee: null, d: "Phy external pure", types: ["external", "hard"] },
  ...
  { id: "sl_petal_finger", n: "ดัชนีเด็ดบุปผา", sc: "เส้าหลิน", ti: 3, w: "fist", mg: 80, st: { POW: 8, INT: 9, DEX: 7 }, at: "int", bp: 70, p: 0, f: 0, dm: 1.15, se: { t: "buff_eva", v: 15, u: 5 }, ee: { t: "debuff_acc", v: -12, u: 5 }, d: "Int×1.15 + Eva+15 + Acc-12 (5ตา)", types: ["internal", "soft"] },
  ...
  { id: "sl_thousand_arms", n: "อรหันต์พันกร", sc: "เส้าหลิน", ti: 4, w: "fist", mg: 100, st: { STR: 8, VIT: 12, POW: 5, DEX: 5 }, at: "phy", bp: 88, p: 25, f: 0, dm: 1.2, vitScale: 0.5, se: null, ee: null, d: "Phy×120% + VIT scaling (×0.5/VIT)", types: ["yang", "hard", "external"] },
